...
/obj/item/weapon/restraints/handcuffs/toy
	name = "handcuffs"
	desc = "Fluffy handcuffs for 'gag' purposes."
	icon_state = "handcufftoy"
...
/obj/item/weapon/restraints/handcuffs/cable/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/stack/rods))
		...
		if(M.amount < 4)
			user << "<span class='warning'>You need at least four metal sheets to make good enough weights!</span>"
			return

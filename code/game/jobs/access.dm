...
/proc/get_all_jobs()
	return list("Vault Resident", "Overseer", "Head of Personnel", "Bartender", "Cook", "Botanist", "Quartermaster", "Cargo Technician",
				"Shaft Miner","Janitor", "Librarian", "Lawyer", "Chaplain", "Chief Engineer", "Station Engineer",
				"Chief Medical Officer", "Medical Doctor", "Chemist", "Geneticist", "Virologist",

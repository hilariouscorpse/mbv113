...
/datum/subsystem/ticker/proc/setup()
	...
	world << "<B><FONT color='#b55a23'>The following events shall be remembered under the code name of:<br><FONT color='#cd3000'>[station_name()]</FONT><br><FONT color='#b55a23'>Best of luck with your survival!</FONT></B>"
	world << sound('sound/f13music/game_start.ogg')
			...
			if(Player.stat != DEAD && !isbrain(Player))
				...
				if(station_evacuated) //If the shuttle has already left the station
					if(!Player.onCentcom() && !Player.onSyndieBase())
						Player << "<font color='blue'><b>You managed to survive, but were marooned during the events of [station_name()]...</b></FONT>"
					else
						num_escapees++
						Player << "<font color='green'><b>You managed to survive the events of [station_name()] as [Player.real_name].</b></FONT>"
				else
					Player << "<font color='green'><b>You managed to survive the events of [station_name()] as [Player.real_name].</b></FONT>"
			else
				Player << "<font color='red'><b>You did not survive the events of [station_name()]...</b></FONT>"
